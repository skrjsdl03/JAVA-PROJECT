...
//			Font font = new Font("돋움", Font.BOLD, 20);
			...
			// 이미지
			// 휴가권 - 1
			ImageIcon vacationImage = new ImageIcon("C:\\img\\선물상자.jpg");
			
			// 반차 - 0.5
			ImageIcon halfvationimage = new ImageIcon("C:\\img\\휴가권.jpg");
			
			//랜덤박스
			ImageIcon randomboxImage = new ImageIcon("C:\\img\\선물상자1.jpg");
			
			// 타이틀 라벨 생성
			JLabel titleJLabel = new JLabel("관리자 - 상점");
			SetFont(titleJLabel, 30);
			titleJLabel.setBounds(400, 5, 223, 80);
